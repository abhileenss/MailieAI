...
export default function Landing() {
  ...
  const handleCompleteOnboarding = () => {
    // Store user profile in localStorage for the backend to access
  ...
  if (showOnboarding) {
    ...
    return (
      <>
        <SEOHead 
          title="PookAi - Setup Your AI Email Concierge"
          description="Quick setup to personalize your AI email concierge for founder-specific communication priorities."
        />
